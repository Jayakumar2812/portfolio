export const projects = [
  {
    title: 'POS Blockchain',
    description: "P2P connection established, Nodes automatically sync with each other when a transaction is posted. Implemented Block validation, Signature Validation, Transaction Validation and POS consensus protocol.",
      image: '/images/3.png',
      tags: ['Python'],
  ...
  {
    title: 'EVM Slot Reader',
    description: "It is a Online tool which is mainly used to read private variables from verfied as well as unverfied contracts on EVM based chains.It returns the parsed output in the human readable form from hexdecimal fomrat  stored on-chain.",
      image: '/images/5.png',
      tags: ['Solidity','Ether js','Next js'],
    source: 'https://github.com/0xHashiras/EVM-Storage-Slot-Reader',
    visit: 'https://evm-storage-slot-reader.vercel.app/',
    id: 1,
  },

  {
    title: 'Multimon',
    description: "This is a Cross-chain, 998, Dynamic NFT's used in a Adventurous Exploration Game.It is nothing a but Pokemon Game  in multi-chain where each chain is a realm.",
    image: '/images/4.png',
    tags: ['Solidity','HyperLane','React js','Ether js','Revise API'],
    source: 'https://github.com/0xHashiras/ETH-INDIA-DAPP',
